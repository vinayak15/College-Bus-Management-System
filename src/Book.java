	...
	public class event implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(a.getBalance()<25){
				...
				JOptionPane.showMessageDialog(new Payment("Confirmation",a.getBalance(),a,From.getSelectedItem()+" "+To.getSelectedItem()+" "+Time.getSelectedItem()+" "+Date.getSelectedItem()),"");
